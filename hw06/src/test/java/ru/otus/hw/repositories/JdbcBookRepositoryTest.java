...
class JdbcBookRepositoryTest {
    ...
    void shouldSaveNewBook() {
        var expectedBook = new Book(0, "BookTitle_10500", dbAuthors.get(0), dbGenres.get(0),new ArrayList<>());
    ...
    void shouldSaveUpdatedBook() {
        var expectedBook = new Book(1L, "BookTitle_10500", dbAuthors.get(2), dbGenres.get(2),new ArrayList<>());
    ...
    private static List<Comment> getDbComments(List<Book> dbBook) {
        return IntStream.range(1, 4).boxed()
                .map(id -> new Comment(id, "Comment_" + id,dbBook.get(id-1)))
                .toList();
    }
    ...
    private static List<Book> getDbBooks(List<Author> dbAuthors, List<Genre> dbGenres) {
        return IntStream.range(1, 4).boxed()
                .map(id -> new Book(id, "BookTitle_" + id, dbAuthors.get(id - 1), dbGenres.get(id - 1),new ArrayList<>()))
                .toList();
    }
